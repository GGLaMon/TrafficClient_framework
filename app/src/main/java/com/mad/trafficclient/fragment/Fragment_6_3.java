...
public class Fragment_6_3 extends Fragment {
    ...
    private void getData() {
        ...
        try {
            list = dao.queryBuilder().orderBy("id", false).limit(20L).where().eq("type", 3).query();
    ...
    private void getSense() {
        HttpUtils.request(UrlUtils.url241, new HashMap<String, String>(), Result241.class, new HttpUtils.RequestListener<Result241>() {
            ...
            public void onSuccess(Result241 result) {
                ...
                sense.setValue(result.getLightIntensity());
                sense.setType(3);
