...
public class Fragment_6_6 extends Fragment {
    ...
    private void getData() {
        ...
        try {
            list = dao.queryBuilder().orderBy("id", false).limit(20L).where().eq("type", 6).query();
